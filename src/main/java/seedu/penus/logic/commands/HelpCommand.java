    ...
    public CommandResult execute(ModelManager model) {
        return new CommandResult(
                ("\n\t" + String.format("%-52s %-97s", "Command", "Description") +
                        ...
                        "\n\t" + String.format("%-52s %-97s", "clear [FILTER]", "Clears modules in the specified Year or Semester.") +
                        "\n\t" + String.format("%-52s %-97s", "", "If [FILTER] is not specified, then all modules will cleared.") +
                        ...
                        "\n\t" + String.format("%-52s %-97s", "", "If [FILTER] is not specified, then all modules will shown.") +
                        ...
                        "\n\n\n\t" + String.format("%-52s %-97s", "remove [MODULECODE]", "Removes a module from the planner.") +
                        "\n\n\n\t" + String.format("%-52s %-97s", "status", "Displays the status of Core Modules and MCs taken.") +
                        "\n\n\n\t" + String.format("%-52s %-97s", "taken [MODULE CODE] y/[YEAR] s/[SEMESTER] g/[GRADE]",
                        ...
                        "\n\t" + String.format("%-52s %-97s", "", "Title, Description, Prerequisites, Module Credits") +
                        "\n\t" + String.format("%-52s %-97s", "", "and if it can be SU-ed.") +
                        "\n\n\n\t" + String.format("%-52s %-97s", "init n/[NAME] c/[COURSE NUMBER]", "Initialize User.") +
                        "\n" +
